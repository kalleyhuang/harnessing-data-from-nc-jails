...
table(county_m$census_county_name, is.na(county_m$mental_heath_case_open_end_month))
table(county_m$census_county_name, is.na(county_m$num_new_mental_health_cases))

num_inmate_get_psych_meds
...
For money spent on psychiatric medicine last quarter, 
