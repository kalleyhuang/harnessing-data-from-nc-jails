...
```{r population}
facility %>% 
  select(jurisdiction, year, unsentenced_male, unsentenced_female, sentenced_male, sentenced_female) %>% 
  ...
  mutate(pct_change_unsentenced_male = (unsentenced_male / lag(unsentenced_male) - 1) * 100,
